...
>(({ className, children, showCloseButton = true, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "dialog-motion fixed z-50 grid w-[calc(100%-2rem)] max-w-lg gap-4 rounded-xl border border-border bg-background p-6 text-foreground shadow-2xl shadow-black/30",
        className
      )}
      {...props}
    >
