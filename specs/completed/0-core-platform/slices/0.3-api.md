...
The additive server-sort, keyset-cursor, and total-count contract is specified
by [file explorer slice 2.16](../../2-file-explorer-ui/slices/2.16-folder-sort-http-contract.md).
